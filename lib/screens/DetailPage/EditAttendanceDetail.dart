...
class _EditAttendanceDetailState extends State<EditAttendanceDetail> {
  ...
  Container _edition(BuildContext context) {
    return Container(
        // width: 260,
        // height: 550,
        decoration: BoxDecoration(
                  ...
                  child: TextFormField(
                    ...
                    decoration: InputDecoration(
                        ...
                        label: customRichText(
                            ...
                            colorText: AppColors.primaryText.withOpacity(0.2),
                            fontSize: 12,
                            colorTextMessage:
              ...
              Center(
                child: CustomButton(
                    ...
                    function: () async {
                      ...
                      bool check = await API(context).editAttendanceDetail(
                          widget.studentID ?? '',
                          widget.classes?.classID ?? '',
                          widget.formID ?? '',
                          topicController.text ?? '',
                          getConfirmStatus(selectedValue) ?? 'Deny attendance',
                      ...
                      if (check) {
                        ...
                        await showDialog(
                            ...
                            builder: (builder) => AlertDialog(
                                  title: const Text('Edit Attendance Detail'),
                                  content: Text(
                    ...
                    width: 260,
                    fontSize: 15,
                    colorShadow: AppColors.primaryButton.withOpacity(0.7),
                    borderRadius: 5),
              ),
            ],
          ),
