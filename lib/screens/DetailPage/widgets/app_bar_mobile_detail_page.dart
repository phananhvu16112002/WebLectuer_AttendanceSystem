...
class AppBarMobileDetailPage extends StatelessWidget {
  const AppBarMobileDetailPage({
    super.key,
    required this.socketServerProvider,
    required this.context,
    required this.teacherDataProvider,
  });

  final SocketServerProvider socketServerProvider;
