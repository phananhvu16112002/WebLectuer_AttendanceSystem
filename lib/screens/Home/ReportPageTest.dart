...
class ReportPageTest extends StatefulWidget {
  const ReportPageTest({super.key});

  @override
  State<ReportPageTest> createState() => _ReportPageState();
}

class _ReportPageState extends State<ReportPageTest> {
  String text =
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              customRichText2('${historyReportDialog.createdAt}:', 'Created: ',
                  AppColors.primaryText.withOpacity(0.5)),
              const SizedBox(
                height: 10,
              ),
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              customRichText2(historyReportDialog.historyFeedbacks!.createdAt,
                  'Created: ', AppColors.primaryText.withOpacity(0.5)),
              const SizedBox(
                height: 10,
              ),
